...
import logo from '../../../assets/logo/outsource.png'
                ...
                <div className="navbar-start">
                    <Link to='/'>
                        <div className="lg:flex items-center">
                            ...
                            <p style={{ fontFamily: "Protest Riot" }} className="text-lg font-bold hidden lg:block">Student Networking Hub</p>
                        </div>
                    </Link>
                </div>
                                ...
                                {user ? (
                                    <label htmlFor="my-drawer-4" className="drawer-button btn btn-sm btn-circle">
                                        <div className="avatar">
                                            <div className="lg:w-9 w-8 rounded-full">
                                                <img
